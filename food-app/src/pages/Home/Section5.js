      ...
      <section className="shop_section">
        <Container>
          <Row className="align-items-center">
            ...
            <Col lg={6}>
              <img src="" alt="e-shop" className="img-fluid" /> // DownloadImage --- IGNORE ---
            </Col>
          </Row>
        </Container>
      </section>
                ...
                <Carousel.Caption>
                  <div className="d-flex align-items-center justify-content-between">
                    <div className="brand_img">
                      <img src={Brand1} className="img-fluid" alt="brand-1" /> // Brand1 --- IGNORE ---
                    </div>
                    <div className="brand_img">
                      <img src={Brand2} className="img-fluid" alt="brand-2" /> // Brand2 --- IGNORE ---
                    </div>
                    <div className="brand_img">
                      <img src={Brand3} className="img-fluid" alt="brand-3" /> // Brand3 --- IGNORE ---
                    </div>
                    <div className="brand_img">
                      <img src={Brand4} className="img-fluid" alt="brand-4" /> // Brand4 --- IGNORE ---
                    </div>
                    <div className="brand_img">
                      <img src={Brand5} className="img-fluid" alt="brand-5" /> // Brand5 --- IGNORE ---
                    </div>
                    <div className="brand_img">
                      <img src={Brand6} className="img-fluid" alt="brand-6" /> // Brand6 --- IGNORE ---
                    </div> 
                  </div>
                </Carousel.Caption>
              </Carousel.Item>
